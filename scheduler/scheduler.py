...
class Scheduler:
    def __init__(self, current_position, time_daemon, polling_sec, task_finished_signal, criterion="distance"):
    ...
    def compute_schedule(self, candidate_user_tasks_schedule):
        ...
        for leg in directions_result[0]['legs']:
            ...
            candidate_car_tasks_schedule.append(CarTask(
                ...
                candidate_user_tasks_schedule[pos].get_deadline(), start_time=start_time, actions=candidate_user_tasks_schedule[pos].get_actions()))
